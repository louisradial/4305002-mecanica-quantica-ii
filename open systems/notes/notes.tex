...
\begin{proof}[Resolução]
    ...
    \end{equation*}
    portanto os autovalores de \(\rho_\reduced(t)\) são \(\set{\cos^2\left(\frac12 \omega t\right), \sin^2\left(\frac12 \omega t\right)}.\) Assim, a entropia de von Neumann é
    \begin{align*}
...
Vamos mostrar um mapa dinâmico universal preserva o traço e a positividade 

...
\end{align}
portanto com a aproximação de onda rotante, obtemos
\begin{equation}
...
\todo[Validade da aproximação]

\subsection{Decaimento de um sistema de dois níveis}
...
\end{equation}
Vamos assumir que o operador de dipolo desse sistema admite elementos de matriz não triviais apenas fora da diagonal, como no efeito Stark para o átomo de hidrogênio em um multipleto \(n\). Assim, o operador de dipolo é dado por
\begin{equation}
...
\begin{equation}
    \commutator{H_\mathrm{LS}}{\rho(t)} = \frac{\abs{\vetor{d}}^2 \Delta S}{4} P_j(t) \commutator{\sigma_3}{\sigma_j} = i\frac{\abs{\vetor{d}}^2 \Delta S}{4} \epsilon_{3jk} P_j(t) \sigma_k = i\alpha \gamma_0 \vetor{e}_3 \cdot [\vetor{P}(t) \times \vetor{\sigma}],
\end{equation}
onde
\begin{equation}
    \alpha = \frac{\abs{\vetor{d}}^2 \Delta S}{4\gamma_0} = \frac{3 \Delta S}{16\omega_0^3}.
\end{equation}
...
\begin{equation}
    \begin{cases}
        \dot{P}_1(t) = - \alpha \gamma_0 P_2(t) - \frac{\gamma}2 P_1(t)\\
        \dot{P}_2(t) = \alpha \gamma_0 P_1(t) - \frac{\gamma}2 P_2(t)\\
...
\begin{equation}
    \begin{pmatrix}
        ...
        P_2(t)
    \end{pmatrix}
    = e^{-\gamma t}\begin{pmatrix}
        \cos(\alpha \gamma_0 t) && \sin(\alpha \gamma_0 t)\\
        -\sin(\alpha \gamma_0 t) && \cos(\alpha \gamma_0 t)
    \end{pmatrix}
    \begin{pmatrix}
        P_1(0)\\
        P_2(0)
...
\begin{equation}
    \rho_e(t) = \frac12 + \frac12 P_3(t) = \frac12\left[\frac{1}{2N+1} + P_3(0)\right] e^{-\gamma t} + \frac{N}{2N+1}
\end{equation}
e do estado fundamental por
\begin{equation}
    \rho_g(t) = 1 - \rho_e(t) = \frac{N + 1}{2N + 1} - \frac12\left[\frac{1}{2N+1} + P_3(0)\right] e^{-\gamma t},
\end{equation}
com as coerências dadas por
\begin{equation}
    \rho_{ge}(t) = \frac{P_1(t) + i P_2(t)}{2} = e^{-\gamma t} \left[\frac{P_1(0) + i P_2(0)}{2}\cos(\alpha \gamma_0 t) - \frac{P_1(0) - i P_2(0)}{2}\sin(\alpha \gamma_0 t)\right]
\end{equation}
Para um estado inicial \(\rho(0) = \ketbra{g}{g}\) temos
\begin{equation}
...
isto é
\begin{equation}
    \rho(t) = \rho_T - \frac{N}{2N + 1}e^{-\gamma t} \sigma_3,
\end{equation}
onde 
\begin{equation}
...
\end{equation}
é o estado de equilíbrio térmico.
